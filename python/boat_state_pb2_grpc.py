...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in boat_state_pb2_grpc.py depends on'
...
def add_SendBoatStateServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('boat_state.SendBoatStateService', rpc_method_handlers)
...
def add_StreamBoatStateServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('boat_state.StreamBoatStateService', rpc_method_handlers)
...
def add_GetMapServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('boat_state.GetMapService', rpc_method_handlers)
...
def add_GetCVParametersServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('boat_state.GetCVParametersService', rpc_method_handlers)
