...
class SendBoatStateServiceClient extends $grpc.Client {
  static final _$sendBoatState =
      $grpc.ClientMethod<$0.BoatStateRequest, $0.BoatState>(
  ...
  $grpc.ResponseFuture<$0.BoatState> sendBoatState($0.BoatStateRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SendBoatStateServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.BoatState> sendBoatState_Pre($grpc.ServiceCall call,
      $async.Future<$0.BoatStateRequest> request) async {
    return sendBoatState(call, await request);
  }

  $async.Future<$0.BoatState> sendBoatState(
      $grpc.ServiceCall call, $0.BoatStateRequest request);
}

class StreamBoatStateServiceClient extends $grpc.Client {
  static final _$streamBoatState =
      $grpc.ClientMethod<$0.BoatStateRequest, $0.BoatState>(
  ...
  $grpc.ResponseStream<$0.BoatState> streamBoatState(
      $0.BoatStateRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$streamBoatState, $async.Stream.fromIterable([request]),
        options: options);
  }
}
...
abstract class StreamBoatStateServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.BoatState> streamBoatState_Pre($grpc.ServiceCall call,
      $async.Future<$0.BoatStateRequest> request) async* {
    yield* streamBoatState(call, await request);
  }

  $async.Stream<$0.BoatState> streamBoatState(
      $grpc.ServiceCall call, $0.BoatStateRequest request);
}
...
class GetMapServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.MapResponse> getMap($0.MapRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class GetMapServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.MapResponse> getMap_Pre(
      $grpc.ServiceCall call, $async.Future<$0.MapRequest> request) async {
    return getMap(call, await request);
  }

  $async.Future<$0.MapResponse> getMap(
      $grpc.ServiceCall call, $0.MapRequest request);
}

class GetCVParametersServiceClient extends $grpc.Client {
  static final _$getCVParameters =
      $grpc.ClientMethod<$0.GetCVParametersRequest, $0.GetCVParametersResponse>(
          '/boat_state.GetCVParametersService/GetCVParameters',
          ($0.GetCVParametersRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetCVParametersResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetCVParametersResponse> getCVParameters(
      $0.GetCVParametersRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class GetCVParametersServiceBase extends $grpc.Service {
  ...
  GetCVParametersServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.GetCVParametersRequest,
            $0.GetCVParametersResponse>(
        'GetCVParameters',
        getCVParameters_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetCVParametersRequest.fromBuffer(value),
        ($0.GetCVParametersResponse value) => value.writeToBuffer()));
  }

  $async.Future<$0.GetCVParametersResponse> getCVParameters_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetCVParametersRequest> request) async {
    return getCVParameters(call, await request);
  }

  $async.Future<$0.GetCVParametersResponse> getCVParameters(
      $grpc.ServiceCall call, $0.GetCVParametersRequest request);
}
